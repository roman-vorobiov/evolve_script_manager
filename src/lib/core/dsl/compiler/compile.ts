...
function normalizeSettingAssignment(node: Parser.SettingAssignment): Compiler.SettingAssignment {
    return {
...
function normalizeTrigger(node: Parser.Trigger): Compiler.Trigger {
